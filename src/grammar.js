const basicFilePath = '../logos-ai/yaml/basic.yaml';
const phrasesFilePath = '../logos-ai/yaml/phrases.yaml';
const wordsFilePath = '../logos-ai/yaml/words.yaml';
const grammarFilePath = '../logos-ai/yaml/grammar.yaml';
const determinersFilePath = '../logos-ai/text/determiners.txt';
const pronounsFilePath = '../logos-ai/text/pronouns.txt';
const prepositionsFilePath = '../logos-ai/text/prepositions.txt';
const complementizersFilePath = '../logos-ai/text/complementizers.txt';
