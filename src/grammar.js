...
const basicFilePath = resolve('./yaml/basic.yaml');
const phrasesFilePath = resolve('./yaml/phrases.yaml');
const wordsFilePath = resolve('./yaml/words.yaml');
const grammarFilePath = resolve('./yaml/grammar.yaml');
const determinersFilePath = resolve('./text/determiners.txt');
const pronounsFilePath = resolve('./text/pronouns.txt');
const prepositionsFilePath = resolve('./text/prepositions.txt');
const complementizersFilePath = resolve('./text/complementizers.txt');
