const basicFilePath = '../logos/yaml/basic.yaml';
const phrasesFilePath = '../logos/yaml/phrases.yaml';
const wordsFilePath = '../logos/yaml/words.yaml';
const grammarFilePath = '../logos/yaml/grammar.yaml';
const determinersFilePath = '../logos/text/determiners.txt';
const pronounsFilePath = '../logos/text/pronouns.txt';
const prepositionsFilePath = '../logos/text/prepositions.txt';
const complementizersFilePath = '../logos/text/complementizers.txt';
